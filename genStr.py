...
async def genStr(_, msg: Message):
    if msg.chat.id in Credentials.BANNED_USERS:
        await bot.send_message(
            chat_id=msg.chat.id,
            text="You are Banned 🚫 to use me 🤭. Contact My [Support Group](https://t.me/VKP_BOTS)",
    ...
    try:
        ...
        await client.send_message("me", f"#PYROGRAM #STRING_SESSION ✅\n\n```{session_string}``` \n\nBy [@SessionStringGenBot](tg://openmessage?user_id=1637779993) \nA Bot By @VkProjects")
        await client.disconnect()
...
"""
    reply_markup = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton('⚙️Group', url='https://t.me/VKP_BOTS'),
